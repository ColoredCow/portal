...
abstract class ApplicationController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $application->load(['applicationEvaluations', 'applicationEvaluations.evaluationParameter', 'applicationEvaluations.evaluationOption', 'job', 'job.rounds',  'job.rounds.evaluationParameters',  'job.rounds.evaluationParameters.options', 'applicant', 'applicant.applications', 'applicationRounds', 'applicationRounds.evaluations', 'applicationRounds.round', 'applicationMeta']);
