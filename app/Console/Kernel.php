...
use Modules\HR\Emails\ApplicationLifeCycleEmailTrigger;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        ApplicationLifeCycleEmailTrigger::class,
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('hr:application-lifecycle-email')->everyday()->at('08:00');
    }
