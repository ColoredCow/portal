                            ...
                            @foreach ($client->projects as $project)
                                <tr>
                                    ...
                                    <td class="w-20p">
                                        ...
                                        <span
                                            class="{{ $textColor }} font-weight-bold">{{ $project->getVelocityForMonthAttribute($monthToSubtract=null, $startDate = null , $endDate = null ) . ' (' . $project->current_hours_for_month . ' Hrs.)' }}</span>
                                    </td>
                                </tr>
                            @endforeach
                        @empty
