            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-check mt-2">
                        ...
                        <label for="issue_templates"><h4 class="ml-3">Issue templates</h4></label>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-check mt-2">
                        ...
                        <label for="unit_testing"><h4 class="ml-3">Unit testing</h4></label>
                    </div> 
                </div>
                <div class="form-row">
                    <div class="form-check mt-2">
                        ...
                        <label for="ci_check"><h4 class="ml-3">CI</h4></label>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-check mt-2">
                        ...
                        <label for="site_monitoring"><h4 class="ml-3">Site monitoring</h4></label>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-check mt-2">
                        ...
                        <label for="error_logging"><h4 class="ml-3">Error logging</h4></label>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-check mt-2">
                        ...
                        <label for="error_reporting"><h4 class="ml-3">Error reporting</h4></label>
                    </div>
                </div>
            </div>
