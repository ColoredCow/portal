        ...
        <form  action="{{ route('project.update', $project) }}" method="POST" id="update_project_team_member_form">
            ...
            <div class="card-body form-body">
                ...
                <div class="row mb-3" v-for="(projectTeamMember, index) in projectTeamMembers" :key="projectTeamMember.id">
                    ...
                    <div class="col-1">
                        <button v-on:click="removeProjectTeamMember(index)" type="button" class="btn btn-danger btn-sm mt-1 ml-2 text-white fz-14" disabled="disabled">Remove</button>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-primary save-btn" v-on:click="updateProjectForm('update_project_team_member_form')" disabled="disabled">Save</button>
            </div>
        </form>
    </div>
