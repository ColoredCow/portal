            ...
            <div class="card-body form-body">
                ...
                <div class="row mb-3" v-for="(projectTeamMember, index) in projectTeamMembers" :key="projectTeamMember.id">
                    ...
                    <div class="col-1 daily-effort-div" >
                        <input type="number" :name="`project_team_member[${index}][daily_expected_effort]`"  class="form-control daily-effort">
                    </div>

                    <div class="col-1 weekly-effort-div">
                        <input type="number" :name="`project_team_member[${index}][daily_expected_effort]`" class="form-control weekly-effort">
                    </div>

                    <div class="col-1 monthly-effort-div">
                        <input type="number"  :name="`project_team_member[${index}][daily_expected_effort]`," class="form-control monthly-effort">
                    </div>
                    <div class="col-1">
