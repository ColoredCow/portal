        ...
        <div id="project_Techstack_Form">
            ...
            <div class="form-group row m-5">
                ...
                <div class="col-sm-6 m-4">
                    <input type="text" name="language" class="form-control" id="language" placeholder="Language" value="{{ old('language', $projectmeta->where('key', 'language')->first()->value ?? '') }}">
                </div>
            </div>
            <div class="form-group row m-5">
                <label for="framework" class="col-sm-4 col-form-label m-4">Framework</label>
                <div class="col-sm-6 m-4">
                    <input type="text" name="framework" class="form-control" id="framework" placeholder="Framework" value="{{ old('framework', $projectmeta->where('key', 'framework')->first()->value ?? '') }}">
                </div>
            </div>
            <div class="form-group row m-5">
                <label for="database" class="col-sm-4 col-form-label m-4">Database</label>
                <div class="col-sm-6 m-4">
                    <input type="text" name="database" class="form-control" id="database" placeholder="Database" value="{{ old('database', $projectmeta->where('key', 'database')->first()->value ?? '') }}">
                </div>
            </div>
            <div class="form-group row m-5">
                <label for="hosting" class="col-sm-4 col-form-label m-4">Hosting</label>
                <div class="col-sm-6 m-4">
                    <input type="text" name="hosting" class="form-control" id="hosting" placeholder="Hosting" value="{{ old('hosting', $projectmeta->where('key', 'hosting')->first()->value ?? '') }}">
                </div>
            </div>
