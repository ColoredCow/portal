...
<div class="mx-15" id="vueContainer">
    ...
    <div class="d-flex justify-content-between mb-2">
        ...
        <span>
            <a href="{{ route('reports.finance.monthly-sales-register.export', request()->all()) }}" class="btn btn-info text-white"> Export To Excel</a>
        </span>
    </div>
    <br>
    <br>
    <div>
        @include('report::finance.monthly-sales-register.filters')
    </div>
