		...
		<table class="table table-bordered table-striped">
			<thead class="thead-dark">
				<tr>
					...
					<th width="40%">Working staff type </th>
					<th>Actions</th>
				</tr>
			</thead>
			<tbody>
				<tr v-for="(user, index) in filteredUsers" :key="index">
					...
					<td>
						<div>{{ user.employee ? user.employee.staff_type : '-' }}</div>
					</td>
					...
					<td>
						...
						<div>
							...
							<button v-show="userPermissions['can-assign-roles']" class="btn btn-edit btn-outline-dark"
								data-toggle="modal" data-target="#update_staff_type_modal"
