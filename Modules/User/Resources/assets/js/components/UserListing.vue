                    ...
                    <td>
                        ...
                        <div>
                            <button v-show="userPermissions['can-assign-roles']" class="btn btn-sm btn-outline-info mr-4"
                                ...
                                @click="updateUserRolesModal(index)">Manage user roles</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Are you sure you want to take this action? It cannot be undone. The user will be removed from the
                        system and will not be able to log in.
                    </div>
