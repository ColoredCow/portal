        ...
        <div class="col" id="user-settings-content">
            ...
            <div class="card-body">
                <h5 class="max-interview-heading fz-20">Maximum interviews in a day:
                    <input type="number" class="col-xs text-center outline-none h-40 w-68 rounded-12 quantity" id="quantity" name="max_interviews_per_day" min="0" max="15" value="{{ old ('max_interviews_per_day', Auth::user()->metaValue('max_interviews_per_day')) }}">
                </h5>        
