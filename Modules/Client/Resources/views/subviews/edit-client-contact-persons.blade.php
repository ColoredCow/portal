    ...
    <div id="client_contact_person_form" class="collapse show" data-parent="#edit_client_form_container">
        <div class="card-body">
            ...
            <div class="row mt-3" v-for="(contactPerson, index ) in this.contactPersons" :key="'contact-person' + '' + contactPerson.id">
                ...
                <div class="col-2">
                    <input v-model="contactPerson.phone"  class="form-control" type="tel" :name="`client_contact_persons[${index}][phone]`" pattern="[1-9]{1}[0-9]{9}" title="The phone must be valid 10 digit.">
                </div>
