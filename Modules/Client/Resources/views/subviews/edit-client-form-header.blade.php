<div class="theme-tabs-container">
    <div class="theme-tabs d-flex overflow-x-scroll mb-2 mx-md-auto">
        <div class="theme-tabs-inner font-muli-bold px-2 px-md-0 d-flex justify-content-md-center mx-md-auto">
            ...
            <div onclick="window.location.href='{{ route('client.edit', [$client, 'billing-details']) }}'"  class="theme-tab c-pointer flex-center px-2 py-1 px-xl-4 py-xl-2 bg-theme-gray-lighter hover-bg-theme-gray-light rounded-6 mr-1 mr-xl-2  {{ $section == 'billing-details' ? 'active' : '' }}">Billing details</div>
