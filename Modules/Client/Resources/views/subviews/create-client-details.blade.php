            ...
            <div class="form-row">
                <div class="col-md-5 form-check-inline mr-0 form-group">
                    <input type="checkbox" {{ ($client->has_departments || old('has_departments') == "1") ? 'checked' : '' }} class="checkbox-custom mb-1.9 mb-1.67 mr-3" name="has_departments" id="has_departments"
                            value="1">
                    <label for="has_departments">Has multipleeeeee departments?
                        <span data-toggle="tooltip" data-placement="right" title="Check if this client will have departments as a new client."><i class="fa fa-question-circle"></i></span>
                    </label>
                </div>
            </div>
        </div>
