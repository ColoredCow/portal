...
@section('content')
    <div class="container">
        <div id="editCentreModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="editCentreModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <script type="text/javascript">
        ...
        $('#editCentreModal').on('hidden.bs.modal', function () {
            redirectToIndex();
        });
