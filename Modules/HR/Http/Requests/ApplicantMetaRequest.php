...
class ApplicantMetaRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'head_shot_image' => 'required|mimes:jpg,jpeg,png,pdf',
            'aadhar_card_number' => 'required|integer',
            'aadhar_card_scanned' => 'required|mimes:jpg,jpeg,png,pdf',
            'pan_card_number' => 'required|integer',
            'scanned_copy_pan_card' => 'required|mimes:jpg,jpeg,png,pdf',
