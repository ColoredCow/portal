...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <a href="{{ route('universities.create') }}" class="btn btn-success btn-block btn-lg"><i class="fa fa-plus fa-light icon-0.2x"></i><span style="font-size:medium;"> Add New University</span></a>
        </div>
    </div>
