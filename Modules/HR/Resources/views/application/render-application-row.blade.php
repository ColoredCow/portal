<tr>
	...
	<td>
		<div class="d-flex flex-column">
			<span>{{ $application->job->title }}   <span data-toggle="tooltip" data-placement="right" title="Total resources required -{{$application->job->jobRequisition->count()}} Total applications available -{{$openApplicationsCountForJobs[$application->job->title]}}"><i class="fa fa-info-circle"></i>&nbsp;</span></span>
