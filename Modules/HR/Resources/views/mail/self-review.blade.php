<div>
    ...
    <h5>Your assessment sheet
        Target date: 23rd May 2023</h5>
    ...
    <p>We are new to this model and we all need to train ourselves to do a great assessment. That’s why we created a few
        ...
        <p>- Evaluation guideline - To run this model for self assessment.</p>
        <p>- Training model on the holistic growth parameters for all the roles in the organization.</p>
        <h5>The end goal is to educate ColoredCow Remarkables through a method of case studies. Keep visiting this training model for new learnings and betterment
        </h5>
