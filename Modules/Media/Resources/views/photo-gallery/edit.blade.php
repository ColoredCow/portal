  ...
  <div class="col-lg-6 mx-auto">
    <div class="card shadow">
      ...
      <div class="card-body p-4">
        <form action="/photo-gallery/{{ $PhotoGallery->id }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="my-2"><h3 class="text-secondary">Event Name</h3>
            <input type="text" name="event_name" id="event_name" class="form-control" placeholder="Event_name" value="{{ $PhotoGallery->event_name }}" required>
          </div>
          <div class="my-2"><h3 class="text-secondary">File Upload</h3>
            <input type="file" name="file" id="file" accept="image/*" class="form-control">
          </div>

          <img src="{{ asset('storage/images/'.$PhotoGallery->img_url) }}" class="img-fluid img-thumbnail" width="150">
