                            ...
                            <tr>
                                <td>  
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <button class="border border-secondary rounded bg-transparent" data-bs-toggle="tooltip" data-bs-placement="down" title="Download Certificate" data-toggle="modal" data-target="#candidateCertificate{{ $applicant->id }}" hidden><i class="fa fa-download"></i></button>
                                        </div>
                                    </div>
