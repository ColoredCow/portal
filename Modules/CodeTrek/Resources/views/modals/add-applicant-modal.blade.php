                     ...
                     <div class="form-row">
                         ...
                         <div class="form-row">
                             <div class="form-group col-md-5">
                                 ...
                                 <input type="email" class="form-control" name="email_id" id="email" placeholder="Enter applicant email"
                                     required="required" value="">
                             </div>
                             <div class="form-group offset-md-1 col-md-5">
                                <label for="phone" class="field-required">Phone Number</label>
                                <input type="text" class="form-control" name="phone" id="phone_no" placeholder="Enter Phone Number"
                       ...
                       <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" class="form-control" name="github_username" id="githubUsername" placeholder="Enter applicant's username"
                                required="required" value="">
                        </div>
                           <div class="form-group offset-md-1 col-md-5">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" class="form-control" name="university_name" id="universityName" placeholder="Enter University"
                                required="required" value="">
                        </div>
                          <div class="form-group offset-md-1 col-md-5">
                              <label for="course" class="field-required">Course</label>
                              <input type="text" class="form-control" name="course" id="courseName" placeholder="Enter course name"
                                  required="required" value="">
                          </div>
                     </div>
                    <div class="form-row">
