...
use Modules\Invoice\Exports\MonthlySalesRegisterReportExport;
...
class InvoiceService implements InvoiceServiceContract
{
    ...
    public function monthlySalesRegisterReport($filters)
    {
        $invoices = Invoice::query()->applyfilters($filters)
            ->orderBy('sent_on', 'desc');
    ...
    public function monthlySalesRegisterReportExport($filters)
    {
        $invoices = $this->taxReportInvoices($filters);
        $month = $filters['month'];
        $year = $filters['year'];
