    ...
    <div class="container" id="vueContainer">
        ...
        <div class="d-flex justify-content-between mb-2">
            ...
            <span>
                ...
                <a href="{{ route('invoice.create') }}" class="btn btn-success ml-2 text-white"><i
                    ...
                    @elseif(
                        ...
                        @foreach ($projectsReadyToSendInvoicesData as $project)
                            ...
                            <tr>
                                ...
                                <td>
                                    @include('invoice::modals.automatic-invoice-details')
                                    ...
                                    @else
                                        ...
                                        @if (
                                            $project->client->billingDetails->service_rate_term == config('client.service-rate-terms.per_hour.slug') ||
