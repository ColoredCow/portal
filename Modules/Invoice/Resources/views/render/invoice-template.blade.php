        ...
        <div class="w-100p">
            ...
            <table>
                <tbody>
                    <tr valign="top">
                        <td>
                            <img src="{{ public_path() . '/images/coloredcow.png' }}" alt="" height="50"
                                width="200">
                        </td>
                    ...
                    <tr class="w-100p">
                        <td align="left" class="w-70p">
                            ...
                            <p>{{ optional($client->addresses->first())->city . ', ' . optional($client->addresses->first())->state . ', ' . optional($client->addresses->first())->area_code }}
                            </p>
            ...
            <div><br>
                <table class="table w-67p" style="margin-left:33%;">
                    ...
                    <tr class="border-bottom">
                        ...
                        <td></td>
                        <td>{{ $client->country->initials == 'IN' ? config('invoice.invoice-details.igst') : __('NILL') }}
                        </td>
                        <td>{{ $currencySymbol . ($billingLevel == 'client' ? $client->getTaxAmountForTerm($monthsToSubtract, $projects, $periodStartDate, $periodEndDate) : $project->getTaxAmountForTerm($monthsToSubtract, $periodStartDate, $periodEndDate)) }}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            @if ($billingLevel == 'client')
                                @if (optional($client->billingDetails)->service_rate_term == config('client.service-rate-terms.per_resource.slug'))
                                    {{ '' }}
                                @else
                                    {{ $currencySymbol . $client->getTotalPayabl    eAmountForTerm($monthsToSubtract, $projects, $periodStartDate, $periodEndDate) }}
                                @endif
                            @else
                                @if (optional($client->billingDetails)->service_rate_term == config('client.service-rate-terms.per_resource.slug'))
                                    {{ $currencySymbol . $project->getResourceBillableAmount() }}
                    ...
                    <tr class="border-bottom">
                        ...
                        <td></td>
                        <td></td>
                        <td>{{ $currencySymbol . $client->getAmountPaidForTerm($monthsToSubtract, $projects, $periodStartDate, $periodEndDate) }}
                        </td>
                    </tr>
                    <tr class="border-bottom">
                        <td>
                ...
                <table class="table-borderless transaction-details w-60p">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ config('invoice.finance-details.transaction-method.value.bank-transfer.value') }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="{{ $billingLevel == 'client' ? $client->effort_sheet_url : $project->effort_sheet_url }}"
                                    target="_blank">For more details of this invoice you can visit this sheet.</a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr colspan="2">
                            <td>
                                <img class="stamp" src="{{ storage_path('app/stamp/coloredcow-stamp.png') }}"
                ...
                <table class="table-borderless transaction-details w-60p">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ config('invoice.finance-details.international.correspondent-bank-swift-code') }}
                            </td>
                        </tr>
                        <tr>
