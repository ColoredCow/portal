            ...
            <div class="modal-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="email" name="cc" id="cc" class="form-control" value="{{$invoice->client->cc_emails}}">
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <input type="email" name="bcc" id="bcc" class="form-control" value="{{$invoice->client->bcc_emails}}">
                    </div>
                    <div class="form-group col-md-12">
