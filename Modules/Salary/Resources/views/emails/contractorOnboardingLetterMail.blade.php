<div>Dear {{$employee['employeeFirstName']}},</div><br>
<div>Congratulations! </div><br>
<div>
    Regarding our earlier communication, we are pleased to inform you that you have been onboared as an employee from {{ $employee['commencementDate'] }}<br><br>
