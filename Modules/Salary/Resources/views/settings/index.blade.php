                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2">% of gross salery</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="help-text text-muted fz-14">If the gross salery will be high with this limit
                                then ESI
                                will not
                        ...
                        <div class="form-group">
                            <label for="">EDLI Maximun salaery limit</label><br>
                            <span class="help-text text-muted fz-14">If the basic salery will be high with this
                                limit
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <label for="">HRA</label>
                            <div class="input-group mb-3">
                                <input style="flex-grow: 0.2;" name="hra[rate]" type="number" class="form-control w-10"
                                    placeholder="%"
