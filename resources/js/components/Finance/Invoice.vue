    ...
    <div class="card-body">
      ...
      <div v-for="(billing, index) in billings">
        <invoice-project-component
          ...
          :billing="billing"
          v-bind:key="index"
          v-on:remove="removeProject(index)"
        >
        </invoice-project-component>
      </div>
      <button
      ...
      <div class="form-row mb-4">
        <div class="form-group col-md-2">
          <label for="project_invoice_id" class="field-required"
            >Invoice ID</label
          >
          <input
            type="text"
      ...
      <div class="form-row mb-4">
        <div class="form-group col-md-5" v-if="file">
          ...
          <div>
            <a target="_blank" :href="'/finance/invoices/download/' + file"
              ><i class="fa fa-file fa-3x text-primary btn-file"></i
            ></a>
          </div>
        </div>
        <div class="form-group col-md-5" v-else>
          <label for="invoice_file" class="field-required"
