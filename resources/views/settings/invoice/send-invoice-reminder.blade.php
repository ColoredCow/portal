<div class="card">
    <form action="{{ route('setting.invoice.update') }}" method="POST">
        @csrf
        <div class="card-header c-pointer" data-toggle="collapse" data-target="#sendInvoiceReminder" aria-expanded="true" aria-controls="sendInvoice">{{ __('Send invoice reminder') }}</div>
        <div id="sendInvoiceReminder" class="collapse">
            <div class="card-body">
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="setting_key[invoice_reminder_subject]">{{ __('Subject') }}</label>
                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="setting_key[invoice_reminder_body]">{{ __('Mail body:') }}</label>
