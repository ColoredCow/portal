...
@section('content')
  ...
  <div class="tab-content">
    <div class="tab-pane active" id="round-wise-rejections" role="tabpanel" aria-labelledby="round-wise-rejections-tab">
      <div class="card">
        <div class="card-header" hight="10px" align='left'>
          <span class="chart-heading mr-2">Rounds</span><span class="total-chart-count">Total rejected application count</span>
          <span>
        ...
        <div class="card-body chart-data" data-target="{{ $chartData }}">
          <canvas id="myGraph" data-target="{{ $chartData }}"width="800%" height="280px"></canvas>
        </div>
      </div>
    </div>
    <div class="tab-pane" id="rejection-reasons" role="tabpanel" aria-labelledby="rejection-reasons-tab">
      <div class="card">
        <div class="card-header" hight="10px" align='left'>
          <span class="chart-heading mr-2">Reason</span> <span class="total-chart-count">Rejected Application Count</span>
          <span>
            <div class="d-inline-flex p-2 ml-25" >
        ...
        <div id="BarGraph" class="card-body chart-data" data-target="{{ $chartBarData }}">
          <canvas id="myBarGraph" data-target="{{ $chartBarData }}" width="800%" height="250px"></canvas>
        </div>
      </div>
    </div>
  </div>
