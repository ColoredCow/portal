                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('channel.create') }}" method="POST" id="addChannel">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="channel-form-save-btn btn btn-primary" id="channelButton">Save
                                    changes</button>
                            </div>
                        </form>
                    ...
                    <div class="form-row mb-4">
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" id="wa_optin_at" class="form-control" name="wa_optin_at"
                                    placeholder="Whatsapp Optin At" value={{ old('wa_optin_at') }}>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 offset-md-1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="graduation_year" id="graduation_year"
                                    placeholder="Graduation Year" value="{{ old('graduation_year') }}">
                            </div>
