            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <div class="mb-1">
                            <a href="/hr/recruitment/job/{{ $application->id }}/edit" class="btn btn-primary"
                                target="_self">Screen resume</a>
                        ...
                        <div class="text-right fz-14">
                            <span class="c-pointer btn-clipboard text-right"
                                data-clipboard-text="{{ $application->getScheduleInterviewLink() }}" data-toggle="tooltip"
                                title="Click to copy">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        @if ($universities->isNotEmpty())
                            <select name="university_id" id="application_university_id"
                                class="form-control form-control-sm pr-md-7" data-applicant-id="{{ $applicant->id }}">
                    ...
                    <div class="form-group offset-md-1 col-md-5">
                        ...
                        <div>
                            ...
                            @includeWhen(isset($hasGraduated) && !$hasGraduated, 'hr.job-to-internship-modal', [
