        ...
        <div class ="navbar"  id="navbar">
            <li id="list-styling">
                <a id="job-application-listings" class= "{{ $status === config('constants.hr.status.new.label') ? 'job-application-status' : '' }} btn"
                    ...
                    <h5 class="application-menu-headings fz-20 {{ $status === config('constants.hr.status.new.label') ? 'text-underline' : '' }}">Open</h5>
                </a>
            </li>
            <li id="list-styling">
                ...
                href=/{{ Request::path() }}?status={{ config('constants.hr.status.in-progress.label') }}{{$query_filters}}&round=trial-program>
                    ...
                    <h5 class="application-menu-headings fz-20 {{ $status === config('constants.hr.status.in-progress.label') ? 'text-underline' : '' }}">Trial Program</h5>    
                </a>
            </li>
            <li id="list-styling">
                ...
                href=/{{Request::path() .'?status='. config('constants.hr.status.on-hold.label')}}{{$query_filters}}>
                    ...
                    <h5 class="application-menu-headings fz-20 {{ $status === config('constants.hr.status.on-hold.label') ? 'text-underline' : '' }}">On Hold</h5>
                </a>
            </li>
            <li id="list-styling">
                ...
                href= /{{ Request::path() }}?status={{ config('constants.hr.status.no-show.label') }}{{$query_filters}}>
                    ...
                    <h5 class="application-menu-headings fz-20 {{ $status === config('constants.hr.status.no-show.label') ? 'text-underline':'' }}">No Show</h5>
                </a>
            </li>
            <li id="list-styling">
                ...
                href= /{{ Request::path() .'?status='. config('constants.hr.status.sent-for-approval.label')}}{{$query_filters}}>
                    ...
                    <h5 class="application-menu-headings fz-20 {{ $status === config('constants.hr.status.sent-for-approval.label') ? 'text-underline' : '' }}">To Approve</h5>
                </a>
            </li>
            <li id="list-styling">
                ...
                href= /{{ Request::path() }}?status={{ config('constants.hr.status.approved.label') }}{{$query_filters}}>
                    ...
                    <h5 class="application-menu-headings fz-20 {{ $status === config('constants.hr.status.approved.label') ? 'text-underline' : '' }}">Approved</h5>
                </a>
            </li>
            <li id="list-styling">
                ...
                href= /{{ Request::path() }}?status={{ config('constants.hr.status.onboarded.label') }}{{$query_filters}}>
                    ...
                    <h5 class="application-menu-headings fz-20 {{ $status === config('constants.hr.status.onboarded.label') ? 'text-underline' : '' }}">On Boarded</h5>
                </a>
            </li>
            <li id="list-styling">
                ...
                href= /{{ Request::path() }}?status={{ config('constants.hr.status.rejected.label') }}{{$query_filters}}>
                    ...
                    <h5 class="application-menu-headings fz-20 {{ $status === config('constants.hr.status.rejected.label') ? 'text-underline':'' }}">Closed</h5>
                </a>
            </li>
        </div>
    </div>    
