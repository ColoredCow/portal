...
<div class="w-md-600 w-300 mx-auto pt-5 text-center">
	<br>
		...
		<div class="mt-9">
			...
			<a href="{{route('hr.applicant.show-applicant-form-details', $hr_applicant_id)}}">Click here to Verify</a><br><br><br><br>
			<h3>In case If you want to update the Details</h3>
			<a href="{{route('hr.applicant.view-form',[$hr_applicant_id,$hr_applicant_email])}}">Click here</a>
        </div>
</div>
@endsection