            ...
            <div class="content">
                @switch($item['type'])
                    ...
                    @case('round-conducted')
                        ...
                        {{ $applicationRound->round->isTrialRound($applicationRound->round->id)? $applicationRound->trialRound->name : $applicationRound->round->name }} for {{ $application->job->title }} conducted by {{ $applicationRound->conductedPerson->name }}<br>
