                                ...
                                @foreach($user->activeProjectTeamMembers as $activeProjectTeamMember)
                                    @if($activeProjectTeamMember->project->status == 'active')
                                        <tr>
                                            ...
                                            <td>
                                                <div class="{{ $activeProjectTeamMember->project->getbillableEffortOfTeamMember($activeProjectTeamMember->id) == ($activeProjectTeamMember->project->getActualEffortOfTeamMember($activeProjectTeamMember->id)) ? 'text-success' : 'text-danger' }}"> {{ $activeProjectTeamMember->non_billable_effort }}</div>
                                            </td>
