            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="date" class="form-control" min ="{{ old('start_date', $job->start_date) }}" max="{{ old('end_date', $job->end_date) }}" value="{{ old('start_date', $job->start_date) }}">     
                    </div>
                    <div class="col-md-3 form-group">
                        <label for="end_date" class="fz-14 leading-none text-secondary mb-1">End Date</label>
                        <input type="date" class="form-control" min ="{{ old('start_date', $job->start_date) }}" value="{{ old('end_date', $job->end_date) }}">
                    </div>
                </div>
