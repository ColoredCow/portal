<div class="timeline mb-5">
    <div class="timeline-container">
        <div class="content">
            <b>{{ date('d/m/Y', strtotime($applicant->created_at)) }}</b><br>
    ...
    @foreach ($applicant->applicantRounds as $applicantRound)
        @if ($applicantRound->scheduled_date)
            <div class="timeline-container">
                <div class="content">
                    {{ $applicantRound->round->name }} scheduled on {{ date('d/m/Y', strtotime($applicantRound->scheduled_date)) }}
                </div>
            </div>
        @endif
        @if ($applicantRound->conducted_date)
            <div class="timeline-container">
                <div class="content">
                    <b>{{ date('d/m/Y', strtotime($applicantRound->conducted_date)) }}</b><br>
        ...
        @if ($applicantRound->mail_sent)
            <div class="timeline-container">
                <div class="content">
                    <b>{{ date('d/m/Y', strtotime($applicantRound->mail_sent_at)) }}</b><br>
