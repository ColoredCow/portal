<div class="modal fade" id="round_{{ $applicant_round->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="/hr/applicant-round/{{ $applicant_round->id }}/sendmail" method="POST">
                ...
                <div class="modal-body">
                    <h6 class="mb-4">Sending: {{ $applicant_round->applicant->email }}</h6>
