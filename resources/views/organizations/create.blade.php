    ...
    <div class="offset-md-3 col-md-6">
        ...
        <form action="{{ route('organizations.store') }}" method="POST" enctype="multipart/form-data" id="onboard_organization">
            ...
            <section class="step-onboarding" v-show="step == 1">
                <h3 class="mb-3"><strong>Step 1:&nbsp;</strong>Setup your organization</h3>
            ...
            <section class="step-onboarding" v-show="step == 2">
                <h3 class="mb-3"><strong>Step 2:&nbsp;</strong>Setup G Suite API credentials</h3>
                <ul>
            ...
            <section class="step-onboarding" v-show="step == 3">
                <h3 class="mb-3"><strong>Step 3:&nbsp;</strong>Complete your service account details.</h3>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="gsuite_dwd_private_key">Service Account Private Key (downloaded in the previous step)</label>
            ...
            <section class="step-onboarding" v-show="step == 4">
                <h3 class="mb-3"><strong>Step 4:&nbsp;</strong>Enable APIs</h3>
                <div class="form-group">
                    <label>Enable the following Google APIs for your project so that Employee Portal can make requests and access your organizational data.</label>
                    <ul>
            ...
            <section class="step-onboarding" v-show="step == 5">
                <h3 class="mb-3"><strong>Step 5:&nbsp;</strong>Enable domain-wide delegation from your G Suite admin</h3>
                <div class="form-group">
            ...
            <section class="step-onboarding" v-show="step == 6">
                <h3 class="mb-3"><strong>Step 6:&nbsp;</strong>Set up your workspace</h3>
                <div class="form-group">
