<ul class="navbar-nav mr-auto" style="font-size:16px;">
    @canany(['hr_recruitment_applications.view', 'hr_employees.view', 'hr_volunteers_applications.view',
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu z-index-1100" aria-labelledby="navbarDropdown_sales">
                ...
                @can('hr_employees.view')
                    ...
                    @endphp
                    <a class="dropdown-item" href="{{ route('payroll', ['staff_type' => 'Employee']) }}">Payroll</a>
        ...
        @if (
            (Module::checkStatus('Client') && auth()->user()->can('clients.view')) ||
                (Module::checkStatus('Project') && auth()->user()->can('projects.view')))
            <li class="nav-item dropdown">
  ...
  <!-- Deleted By Sagar -->
        ...
        @endcanany
        <li class="nav-item">
            <a class="nav-item nav-link d-flex justify-content-md-center align-items-center"
                href="{{ config('constants.analytics_dashboard_url') }}" target="_blank">
                <span>Analytics</span>
