<ul class="navbar-nav mr-auto" style="font-size:16px;">
    @if(Module::checkStatus('HR'))
        @canany(['hr_recruitment_applications.view', 'hr_employees.view', 'hr_volunteers_applications.view', 'hr_universities.view', 'employee_appointmentslots.view', 'hr_tags.view'])
            <li class="nav-item dropdown">
                <a id="navbarDropdown_hr" class="nav-link dropdown-toggle" href="#" role="button"
    ...
    @if(Module::checkStatus('Prospect') || Module::checkStatus('Lead') || Module::checkStatus('SalesAutomation'))
        @canany(['prospect.view', 'lead.view'])
            <li class="nav-item dropdown">
    ...
    @if(Module::checkStatus('HR') || Module::checkStatus('User'))
        @canany(['hr_recruitment_applications.view', 'user_management.view'])
            <li class="nav-item dropdown">
