...
<body>-->
    ...
    <div class="container" id="page_hr_applicant_create">
        ...
        <div>
            <form action="{{ route('hr.applicant.storejob') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <select name="job_title" id="job_title" class="form-control" required="required"
                                    ...
                                    <option option id="0" value="Weapons Specialists">Weapons Specialists</option>
                                </select>
